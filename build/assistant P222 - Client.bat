...
assistant.exe --micro-model ../model/vosk-model-fr-0.22 --speaker-voice 0 --micro-device 3 --python-onload "roms/init.py" --python-onlistening "roms/start.py" --playsound-onstartspeaking %onstart%  --playsound-onendspeaking %onend% --speaker-client 192.168.1.222:7979
