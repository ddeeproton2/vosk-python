...
assistant.exe --micro-model ../model/vosk-model-fr-0.22 --speaker-voice 1 --micro-device 10 --python-onload "roms/init.py" --python-onlistening "roms/start.py" --playsound-onstartspeaking %onstart%  --playsound-onendspeaking %onend%
